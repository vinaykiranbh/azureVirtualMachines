...
def main():
    ...
    VM_NAME = Config.getVirtualMachineName()
    NSG_NAME = Config.getSecurityGroupName()
    NSG_INBOUND_RULE_NAME = Config.getinboundRuleName()
    NSG_OUTBOUND_RULE_NAME = Config.getoutboundRuleName()
    ...
    if result_check != True:
        resource_client.resource_groups.create_or_update(
            ...
            parameters={"location": location}  # type: ignore
        )
    ...
    VNET_NAME = Config.getVnetName()
    SUBNET_NAME = Config.getSubnetName()
    IP_NAME = Config.getIpName()
    IP_CONFIG_NAME = Config.getIpConfigName()
    NIC_NAME = Config.getNicName()
    ...
    result = {"Primary IP": ipAddress[0], "Secondary IP": ipAddress[1:],
              "Virtual Machine Name": VM_NAME, "Group Name": GROUP_NAME}
    print(result)
    return result
